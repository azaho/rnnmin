...
task = tasks.TWO_ORIENTATIONS_DOUBLE_OUTPUT_FLAG()
...
if redo_preanalysis:
    ...
    task = tasks.TWO_ORIENTATIONS_DOUBLE_OUTPUT_FLAG(orientation_neurons, hold_orientation_for, hold_cue_for, delay0_set, delay1_set, delay2_set,
